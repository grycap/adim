...
from adm.routers import deployments, allocations, tools, service


def create_app():
    fapp = FastAPI(
        title="EOSC ADM API",
        description="EOSC Application Deployment Management API",
        version="0.1.49",
        docs_url="/",
...
if os.getenv("OPENAPI"):
    with open("adm-api.yaml", "w", encoding="utf-8") as f:
