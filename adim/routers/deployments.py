...
def list_deployments(
    ...
    adim.logger.debug(f"Listing deployments from user '{user_info.get('sub')}'")
...
def get_deployment(deployment_id,
    ...
    adim.logger.debug(f"Getting deployment {deployment_id} from user '{user_info.get('sub')}'")
    deployment, status_code = adim.deployments_manager.get_deployment(deployment_id, user_info, True)
...
def delete_deployment(deployment_id,
    ...
    adim.logger.debug(f"Deleting deployment {deployment_id} from user '{user_info.get('sub')}'")
    res, status_code = adim.deployments_manager.delete_deployment(deployment_id, user_info)
